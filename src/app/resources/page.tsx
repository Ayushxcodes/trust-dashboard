...
function DownloadLink({ href, label, badge = "PDF" }: DownloadLinkProps) {
  return (
    <a
      ...
      className="flex items-center justify-between gap-3 p-3 sm:p-3.5 rounded-xl bg-indigo-50/70 hover:bg-indigo-100/90 border border-indigo-200 text-indigo-950 text-xs font-bold transition-all group shadow-2xs w-full"
    >
      <div className="flex items-center gap-2.5 min-w-0 flex-1">
        ...
        <span className="break-words leading-tight text-xs sm:text-xs">{label}</span>
      </div>
...
export default function ResourcesPage() {
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-800 font-sans">
      ...
      <div className="bg-gradient-to-br from-[#0B1528] to-slate-900 text-white py-10 sm:py-16 border-b border-slate-800">
      ...
      <main className="flex-1 py-8 sm:py-12">
        <div className="container mx-auto px-4 sm:px-6 max-w-5xl space-y-8 sm:space-y-12">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-indigo-100 shadow-xl space-y-5 sm:space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 border-b border-slate-100 gap-3">
              <div>
                <span className="text-[11px] sm:text-xs font-mono uppercase tracking-wider text-indigo-600 font-bold">SEBI Master Circular Requirement</span>
                <h2 className="text-xl sm:text-2xl font-black text-slate-900">Mandatory SEBI ISR &amp; Companies Act Forms</h2>
              </div>
              <span className="text-xs font-bold text-emerald-700 bg-emerald-50 px-3 py-1 rounded-lg border border-emerald-200 self-start sm:self-auto shrink-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            ...
            <section className="bg-white border border-slate-200 rounded-2xl sm:rounded-3xl p-5 sm:p-6 shadow-xs space-y-4">
              <h2 className="text-base sm:text-lg font-bold text-slate-900 pb-2 border-b border-slate-100 flex items-center gap-2">
